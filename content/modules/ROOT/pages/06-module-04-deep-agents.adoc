...
*Next*: Module 5 — switch the ops_manager to OSS too, then explore how much autonomy you'd give an AI operations team.

xref:07-module-05-compliance-loop.adoc[-> Module 5: Can Open Source Models Take Full Control?]
