...
|Built and deployed a new `sre_package_management` specialist agent with institutional knowledge about Meridian's Satellite content views and CRB requirements — using ConfigMap and PVC, no code changes
...
*Tony Kay, Red Hat* — AI Lead, Consulting Technical Marketing Manager
*Burr Sutter, Red Hat* — Senior Director, Developer Experience
*Ragu Banda, Red Hat* — Associate Principal AI Specialist SA
*Ishu Verma, Red Hat* — Senior Principal Technical Marketing Manager
